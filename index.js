// 1. Write a function testNum that takes a number as an argument and returns a 
...
const testNum = num => {
  ...
  // 2. Write two functions that use Promises that you can chain! The first function, 
  //makeAllCaps(), will take in an array of words and capitalize them, and then the 
  //second function, sortWords(), will sort the words in alphabetical order. 
  ...
  //What are good use cases for Promises?
    //Good use cases for Promises are - converting XMLHttpRequests to a 
    //promise-based task, anytime there is a chance that an asynchronous action will be taken.
